...
static void MX_COMP1_Init(void)
{
  ...
  hcomp1.Init.InputMinus = COMP_INPUT_MINUS_DAC1_CH2;
...
static void MX_TIM14_Init(void)
{
  ...
  if (HAL_TIMEx_TISelection(&htim14, TIM_TIM14_TI1_HSE_32, TIM_CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|VR1_Pin|VR2_Pin|VR3_Pin
                          |VR4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(VBI_GPIO_Port, VBI_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SMOO_GPIO_Port, SMOO_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : VBI_Pin */
  GPIO_InitStruct.Pin = VBI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(VBI_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SMOO_Pin */
  GPIO_InitStruct.Pin = SMOO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(SMOO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : VR1_Pin VR2_Pin VR3_Pin VR4_Pin */
  GPIO_InitStruct.Pin = VR1_Pin|VR2_Pin|VR3_Pin|VR4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
